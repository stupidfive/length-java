...
public class LengthTest {
    ...
    public void should_1_inch_equals_1_inch() {
        Length result = new Length(1, "inch").temp_as(Unit.INCH);
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, "f").temp_as(Unit.FOOT);
    ...
    public void should_1_yard_equals_1_yard() {
        Length result = new Length(1, "yard").temp_as(Unit.YARD);
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, "f").temp_as(Unit.INCH);
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, "f").temp_as(Unit.YARD);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, "yard").temp_as(Unit.FOOT);
    ...
    public void should_1_yard_equals_36_inches() {
        Length result = new Length(1, "yard").temp_as(Unit.INCH);
    ...
    public void should_2_yards_equals_72_inches() {
        Length result = new Length(2, "yard").temp_as(Unit.INCH);
    ...
    public void should_12_inches_equals_1_foot() {
        Length result = new Length(12, "inch").temp_as(Unit.FOOT);
    ...
    public void should_36_inches_equals_1_yard() {
        Length result = new Length(36, "inch").temp_as(Unit.YARD);
    ...
    public void should_18_inches_equals_half_yard() {
        Length result = new Length(18, "inch").temp_as(Unit.YARD);
